...
namespace Engine
{
    ...
    {
        private static readonly string _connectionString = "Data Source=(local);Initial Catalog=Arcane;Integrated Security=True";
                ...
                using (SqlConnection connection = new SqlConnection(_connectionString))
                {
                    ...
                    foreach (InventoryItem inventoryItem in player.Inventory)
                    {
                        using (SqlCommand insertInventoryCommand = connection.CreateCommand())
                        {
                            ...
                            insertInventoryCommand.Parameters["@InventoryItemID"].Value = inventoryItem.Detail.ID;
